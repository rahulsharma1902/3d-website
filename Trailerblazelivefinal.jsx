...
Command: npx gltfjsx@6.5.3 public/models/trailerblazelivefinal.glb 
*/
...
export function Model(props) {
  ...
  const { nodes, materials, animations } = useGLTF('/trailerblazelivefinal.glb')
  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
            ...
            <group name="Object_2">
              <group name="RootNode">
                ...
                <group name="pacman" position={[7.345, 37.744, -1.735]} rotation={[-0.815, 0, 0]} scale={0.095}>
                  <group name="mouth_bott" position={[-0.001, 0, 0]}>
                    <group name="Object_13" position={[-0.001, -0.317, 0]}>
                      <mesh name="mouth_bott_pac_&_ghost_0" geometry={nodes['mouth_bott_pac_&_ghost_0'].geometry} material={materials.pac__ghost} position={[-0.001, 0, 0]} />
                    </group>
                  </group>
                  <group name="mouth_top" position={[-0.001, 0, 0]}>
                    <group name="Object_10" position={[-0.001, -0.317, 0]}>
                      <mesh name="mouth_top_pac_&_ghost_0" geometry={nodes['mouth_top_pac_&_ghost_0'].geometry} material={materials.pac__ghost} position={[-0.001, 0, 0]} />
                    </group>
                  </group>
                  <group name="Object_7" position={[-0.001, -0.317, 0]}>
                    <mesh name="pacman_pac_&_ghost_0" geometry={nodes['pacman_pac_&_ghost_0'].geometry} material={materials.pac__ghost} position={[-0.001, 0, 0]} />
                  </group>
                </group>
        ...
        <mesh name="portfolio_text_01003" geometry={nodes.portfolio_text_01003.geometry} material={materials.Material} position={[2856.489, 289.465, -540.059]} scale={[3.617, 1.709, 30.796]} />
        <mesh name="portfolio_text_01004" geometry={nodes.portfolio_text_01004.geometry} material={materials.Material} position={[11317.52, 286.264, -546.981]} scale={[2.69, 1.709, 30.796]} />
...
useGLTF.preload('/trailerblazelivefinal.glb')
