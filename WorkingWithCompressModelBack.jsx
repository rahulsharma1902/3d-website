...
Command: npx gltfjsx@6.5.3 public/models/workingWithCompressModelBack.glb 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/workingWithCompressModelBack.glb')
  return (
...
useGLTF.preload('/workingWithCompressModelBack.glb')
